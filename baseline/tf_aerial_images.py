...
def main(argv=None):  # pylint: disable=unused-argument
    ...
    test_images = "../Datasets/test_set_images/"
    test_predictions = "../Datasets/test_predictions/"
    ...
    def get_test_prediction(filename, image_idx):
    ...
    with tf.Session() as s:
        ...
        if not os.path.isdir(test_predictions):
            os.mkdir(test_predictions)
        for i in range(1, TESTING_SIZE + 1):
            pimg = get_test_prediction(test_images, i)
            print(pimg)
            mpimg.imsave(test_predictions + "prediction_" + str(i) + ".png", pimg)
